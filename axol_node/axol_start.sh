...
sudo chown axol:axol /opt/AXOL_Management/axol_node/database
...
sudo chown axol:apache /opt/AXOL_Management/axol_node/database/*
sudo chmod 775 /opt/AXOL_Management/axol_node/database/*
